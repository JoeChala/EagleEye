...
class Create_id:
    def __init__(self, root):
        ...
        #image1
        img = Image.open(r"C:\Users\Joe\Desktop\project_gallery\emplo1.jpg")
        ...
        #image2
        img1 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\employ5.jpg")
        ...
        #image3
        img2 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\employ4.jpg")
        ...
        #side_img1
        imag1 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\emplo00.jpg")
        ...
        # side_img2
        imag2 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\facbro.png")
        ...
        #Head__img
        h_img = Image.open(r"C:\Users\Joe\Desktop\project_gallery\cap1.jpg")
        ...
        def comm():
            mycursor.execute("select employee_code from employee_details")
            m=list(mycursor.fetchall())
            #print(m)
            mycon.commit()
            #print(type(code_opts.get()))
            for i in m:
                #print(i[0])
                if i[0]==code_opts.get():
                    subroot=Tk()
                    subroot.geometry("600x100")
                    ler=Label(subroot,bg="black",text = "Employee id already exists", font = ("Algerian", 24,'bold'),fg="white")
                    ler.pack(fil = BOTH,expand=True)
                    
                    break
                if len(pho_opts.get())<10:
                    subroot=Tk()
