...
class Login_window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(image=PIL.Image.open(r"C:\Users\Joe\Desktop\project_gallery\bg_login1.jpg"))
        ...
        #logo
        img2=Image.open(r"C:\Users\Joe\Desktop\project_gallery\logo2.jpg")
...
class Admin_window:
    def __init__(self,root):
        ...
        #login background
        self.bg=ImageTk.PhotoImage(image=PIL.Image.open(r"C:\Users\Joe\Desktop\project_gallery\login_bg2.jpg"))
        ...
        passwordbtn.place(x=13,y=350,width=130)
    ...
    #def adminwind(self):
     #   self.root_admn = Toplevel(self.root)
      #  self.admnscrn = AdminWindow(self.root_admn)
    ...
    def login(self):
        ...
        if self.txtuesr.get() == "" or self.txtpass.get() == "":
            ...
            for record in recordlist:
                if self.txtuesr.get()==record[1] and self.txtpass.get()== record[2]:
                ...
                elif self.txtuesr.get()not in record or self.txtpass.get()== record:
...
class User_window:
    ...
    def __init__(self,root):
        ...
        #background images
        img1 =Image.open(r"C:\Users\Joe\Desktop\project_gallery\win_bg.jpg")
        self.photoimg1 = ImageTk.PhotoImage(img1)
        bg_img = Label(self.root,image = self.photoimg1,cursor="hand2")
        bg_img.place(x=0,y=0,width=1400,height=800)
        
        img2 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\topbg_2.jpg")
        ...
        img3 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\topbg_3.jpg")
        img3 = img3.resize((450, 250), Image.ANTIALIAS)
        self.photoimg3 = ImageTk.PhotoImage(img3)
        photo1 = Label(self.root, image=self.photoimg3)
        photo1.place(x=900, y=0)
        
        img4 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\cap3.jpg")
        ...
        img8 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\developers.jpg")
        ...
        #help desk button
        img5 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\fac24.png")
        ...
        img6 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\recognizeface.jpg")
        ...
        #exit button
        img7 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\exit.jpg")
    ...
    def helpdesk(self):
        ...
        #background images
        img1 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\lock.jpg")
        ...
        img2 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\topbg_3.jpg")
        img2 = img2.resize((470, 200), Image.ANTIALIAS)
        photoimg2 = ImageTk.PhotoImage(img2)
        photo1 = Label(Top, image=photoimg2)
        photo1.place(x=0, y=0)
        
        img3 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\topbg_2.jpg")
    ...
    def dev_info(self):
        ...
        #background images
        img3 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\bg_login1.jpg")
        img3 = img3.resize((1400, 780))
        photoimg3 = ImageTk.PhotoImage(img3)
        bg_img = Label(Top,image=photoimg3)
        bg_img.place(x=0, y=0, width=1400, height=780)

        img1 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\codrIcon.jpg")
        img1 = img1.resize((200, 250))
        photoimg1 = ImageTk.PhotoImage(img1)
        photo = Label(Top,image=photoimg1)
        photo.place(x=180, y=200)

        img2 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\codrIcon.jpg")
        img2 = img2.resize((200, 250))
        photoimg2 = ImageTk.PhotoImage(img2)
        photo1 = Label(Top,image=photoimg2)
        photo1.place(x=580, y=200)
    
        img4 = Image.open(r"C:\Users\Joe\Desktop\project_gallery\codrIcon.jpg")
