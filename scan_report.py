...
class Entry_exit_detls:
    def __init__(self, root):
        ...
        img = Image.open(r"C:\Users\Joe\Desktop\project_gallery\graph.png")
        ...
        # Frame_bg
        fram_bg = Image.open(r"C:\Users\Joe\Desktop\project_gallery\bg_main.gif")
        ...
        mycon = sqltor.connect(host = "localhost", user = "root", password = "root", database = "cbse_compsci_proj")
